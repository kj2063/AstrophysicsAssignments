...
from astropy.cosmology import LambdaCDM, FlatwCDM #, FlatLambdaCDM, FlatwCDM
...
def mucdm(zcmb,Om,Ol,MB):
    # Om,Ol,MB = Bounds([0, 0, -10], [1.0, 1.0, -30])
...
res = minimize(chi2_mucdm, x0 = (0,0,-20), bounds=((0.1,1),(0.1,1),(-30,-10)), args=(zcmb,cov))



# def chi2_mufwcdm(par,zcmb,cov):
#     Om = par[0]
#     w = par[1]
#     MB = par[2]
#     return mufwcdm(zcmb,Om,w,MB).T@np.linalg.inv(cov)@mufwcdm(zcmb,Om,w,MB)

# res_fw = minimize(chi2_mufwcdm, x0 = (0,0,-20), args=(zcmb,cov))
